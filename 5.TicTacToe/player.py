...
class Player:
    ...
    # we want all player to get their next move give a game
        ...
        while not valid_square:
            ...
            try:
                ...
                if val not in game.available_moves():
                    raise ValueError
                valid_square = True # if  these are successful, they yay!
            except ValueError:
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        for possible_move in state.available_moves():
            ...
            #step 2: recure using minimax to simulate a game after making that move
            sim_score = self.minimax(state, other_player) #now, we alternate players

            #step 3: undo the move
            state.board[possible_move] = ' '
            state.current_winner = None
            sim_score['position'] = possible_move # otherwise this will get messed up from the recurion
